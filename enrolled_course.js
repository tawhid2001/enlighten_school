const courseDetailinfo = (courseId) => {
    return fetch(`https://enlighten-institute.onrender.com/api/course/courselist/${courseId}`)
      .then((res) => {
        if (!res.ok) {
  ...
  const enrolledCourses = async () => {
    try {
      ...
      const response = await fetch("https://enlighten-institute.onrender.com/api/enrollment/list/", {
        method: "GET",
        headers: {
  ...
  const fetchEnrollments = () => {
    ...
    fetch('https://enlighten-institute.onrender.com/api/enrollment/list/', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        Authorization: `Token ${token}`,
  ...
  const disenroll = (enrollmentId, courseId) => {
    ...
    fetch(`https://enlighten-institute.onrender.com/api/enrollment/enroll/${enrollmentId}/`, {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Token ${token}`,
